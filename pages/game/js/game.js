...
class Game {
  constructor() {
    ...
    this.allowUnlockedDesktopRun = false;
  ...
  _initEvents() {
    ...
    document.addEventListener('mousedown', (e) => {
      ...
      if (!this.isMobile && this.allowUnlockedDesktopRun) {
    ...
    if (!this.isMobile) {
      document.addEventListener('pointerlockchange', () => {
        ...
        } else if (this.isRunning && !this.allowUnlockedDesktopRun) {
          this.ui.pauseScreen.style.display = 'flex';
        }
      });
      ...
      const requestLock = () => {
        if (!this.isPointerLocked && this.isRunning) {
          ...
          setTimeout(() => {
            if (!this.isPointerLocked && this.isRunning) {
              this.allowUnlockedDesktopRun = true;
              this.ui.pauseScreen.style.display = 'none';
              this._showGameUI(true);
              this.canvas.style.cursor = 'grab';
            }
